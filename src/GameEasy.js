...
Ball.GameEasy.prototype = {
	...
	finishLevel: function() {
		if(level >= maxLevels) {
			...
			alert('Congratulations, Easy game completed!\nTotal timer:'+timer2+'\nTry the Medium Difficulty');
			timer = 0;
			level = 1;
			//totalTimer = 0;
			...
			timer = 0;
			level++;
			totalTimeText.content = "Total time: "+timer2;
			levelText.content = "Level: "+level;
			this.game.state.start('GameEasy');
		}
	},
